...
**Задача** — базовая единица работы в системе, имеющая определённую стоимость в баллах и описание необходимых действий.
...
**Лидер команды** — пользователь с расширенными правами, который может создавать команду, задачи и заявки, а также
...
**Баллы** — единицы измерения вклада участников, начисляемые за выполнение задач в соответствии с их стоимостью.
