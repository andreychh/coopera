...
**Отчет** — подтверждение факта выполнения задачи с приложенными доказательствами (фото, описание и т.д.).
...
**Участник команды** — пользователь, который может создавать и выполнять задачи, подтверждать или отклонять отчеты
других участников.
...
* Задача 1.2: Добавить возможность просмотра статистики и истории создания/выполнения задач и отчетов
...
* Задача 4.1: Создать автоматические уведомления о новых задачах, дедлайнах и необходимости подтверждения
* Задача 4.2: Разработать систему коллегиального подтверждения выполненных задач
...
3. **Функциональность для участников**
    ...
    * Система обменов задач между участниками

4. **Автоматические функции**
    * Распределение невзятых задач на основе формального алгоритма
