...
##### 7.1.2.1 Domain Layer (Слой предметной области)
...
##### 7.1.2.2 Data Layer (Слой данных)
...
##### 7.1.2.3 Delivery Layer (Слой доставки)
