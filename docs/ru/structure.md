...
```mermaid
gantt
    title План-график проекта Coopera
    dateFormat  YYYY-MM-DD
    axisFormat  %b %Y

    section Подготовка
    Сбор требований и распределение ролей      :done,    des1, 2025-09-01, 2025-09-30

    section Разработка
    Разработка Frontend и Telegram-бота        :active,  des2, 2025-11-01, 2025-12-20
    Разработка Backend и базы данных           :active,  des3, 2025-10-01, 2025-12-20

    section Интеграция и тестирование
    Интеграция модулей и тестирование системы  :crit,    des4, 2025-11-01, 2025-12-20

    section Презентация
    Подготовка и демонстрация решения          :milestone, des5, 2025-12-01, 2025-12-25
```
