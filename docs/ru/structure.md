...
Каждый участник проекта должен быть обеспечен техникой, соответствующей рекомендуемым требованиям для стабильной работы  
с современными инструментами разработки:
