...
**не предусмотрена в текущем релизе проекта Coopera (осенний семестр 2025 года)**. Для каждого исключенного элемента  
указаны обоснования и возможные перспективы включения в будущие версии.
