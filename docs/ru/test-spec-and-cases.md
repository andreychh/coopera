...
* [Спецификации и сценарии тестов](#спецификации-и-сценарии-тестов)
    ...
    * [6. Тесты](#6-тесты)
        * [6.1. Компонентные тесты](#61-компонентные-тесты)
            ...
            * [Тест 8: Конвертер входных сущностей](#тест-8-конвертер-входных-сущностей)
            * [Тест 9: Корректность кодов ответа](#тест-9-корректность-кодов-ответа)
            * [Тест 10: Проверка участия пользователя в группе](#тест-10-проверка-участия-пользователя-в-группе)
